...
const RedCard = ({ currentMatch, recordMatchEvents }: RedCardProps) => {
  ...
  const handleAddEvent: SubmitEventHandler<HTMLFormElement> = async (event) => {
    ...
    if (!scorerId) {
      toast({
        title: "Erro",
        description: "Selecione o jogador que tomou o cartão vermelho.",
        variant: "destructive",
      });
      return;
    }
    ...
    eventsToRecord.push({
      ...
      playerId: scorerId,
      statType: StatTypeEnum.RED_CARD,
    });
            ...
            >
              <div className="flex items-center justify-between mb-5">
                <h3 className="text-lg font-bold text-foreground">
                  {teamIcon(showEventModal)} Cartão vermelho para{" "}
