...
const Lob = ({ currentMatch, recordMatchEvents }: LobProps) => {
  ...
  const handleAddEvent: SubmitEventHandler<HTMLFormElement> = async (event) => {
    ...
    if (!scorerId) {
      toast({
        title: "Erro",
        description: "Selecione o autor do chapéu.",
        variant: "destructive",
      });
      return;
    }
    ...
    if (!opponentId) {
      toast({
        title: "Erro",
        description: "Selecione o jogador adversário (quem tomou o chapéu).",
        variant: "destructive",
      });
      return;
    }
            ...
            >
              <div className="flex items-center justify-between mb-5">
                <h3 className="text-lg font-bold text-foreground">
                  {teamIcon(showEventModal)} Chapéu do{" "}
              ...
              <form onSubmit={handleAddEvent} className="space-y-5">
                <div className="space-y-2">
                  ...
                  >
                    Autor do chapéu <span className="text-destructive">*</span>
                  </label>
                  <select
                    id="scorerId"
                    name="scorerId"
